...
//Todo: you need to change FTPSERVER to point to your own FTP server, and setup the folder structure the original server ftp.cpetzold.com is no longer valid
