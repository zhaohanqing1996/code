...
public:
    ...
    void setupUi(QWidget *MainWidget)
    {
        ...
        quitBtn = new QPushButton(MainWidget);
        quitBtn->setObjectName(QStringLiteral("quitBtn"));
        quitBtn->setGeometry(QRect(130, 90, 112, 34));
        ...
        pushButton_4->setGeometry(QRect(310, 220, 241, 34));
    ...
    void retranslateUi(QWidget *MainWidget)
    {
        ...
        quitBtn->setText(QApplication::translate("MainWidget", "\351\200\200\345\207\272", 0));
